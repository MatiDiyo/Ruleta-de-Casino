...
*   arbolRanking.c                                                                *
*                                                                                 *
*   Esta librería contine funciones de arboles, la cual maneja como información   *
*   una struct de tipo SCORE, la que contiene el nombre y el puntaje de una       *
*   partida. El proposito de esta librería es mantener el ranking top 10          *
*   actualizado con los mejores puntajes, cuando se habla de puntaje              *
*   se refiere al dinero ganado en una SOLA partida.                              *
*                                                                                 *
*   Asi es como trabaja esta librería:                                            *
*                                                                                 *
*   - Le llega desde menú.c un determinado puntaje.                               *
*   - Inserta el puntaje en el árbol.                                             *
...
/****************************************************************************
	...
	COMENTARIOS:
	- La función es recursiva, asi que las operaciones de abrir y cerrar
	se deben realizar afuera de la función.
****************************************************************************/
...
/****************************************************************************
	PROPOSITO: Función auxiliar de Mostrar score sirve para contar los
...
/****************************************************************************
	PROPOSITO: Esta función se encargar de interactuar con el menú, modifica
...
/****************************************************************************
	PROPOSITO: Traslada la información que hay un arbol a una posición determinada
...
/****************************************************************************
	PROPOSITO: Imprime la última fila del cuadro del ranking.
	COMENTARIOS:
****************************************************************************/
